...
DROP DATABASE Extra_Assignment4;
...
SELECT d.Department_Number,d.Department_Name,COUNT(e.Department_Number) as soluong
...
SELECT e.Employee_Number,e.Employee_Name,COUNT(es.Employee_Number) as kynang
